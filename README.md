...
This repository shows some IIIF experiments based on [Gallica](gallica.bnf.fr) content and real life use cases when working with IIIF documents (see also this [BnF-TNA work](https://docs.google.com/presentation/d/1Q95-5BD55uXJ3fFRbbGK0iWjQI4luByj/edit#slide=id.g17831e8897c_0_71). Most of the content is IIIF Presentation version 2 based.
