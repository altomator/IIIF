...
This repository shows some IIIF experiments based on [Gallica](gallica.bnf.fr) content and real life use cases when working with IIIF documents. Most of the content is IIIF Presentation version 2 based.
